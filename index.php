...
<!-- Weather Forcast -->
<div id="weather-carousel" class="carousel slide " data-bs-ride="carousel" data-bs-interval="10000"  data-bs-pause="false">
    <div id="weather-feed"  class="carousel-inner" ></div>
</div>
...
<!-- News Marquee -->
<div id="news">
    <div class="news-logo d-flex align-items-center justify-content-center">
    ...
    <div id="news-feed" class="d-flex align-items-center"></div>
</div>
...
async function loadWeather() {
    try {
        const response = await fetch("weather-proxy.php");
        const text = await response.text();
        ...
        const container = document.getElementById("weather-feed");
        container.innerHTML = "";
        ...
        entries.forEach((entry, index) => {
            ...
            if (summaryNode) {
                ...
                // ✅ Use innerHTML so tags like <b>, <br>, etc. render properly
                p.innerHTML = summaryNode.textContent;
                div.appendChild(p);
            }
        ...
        console.error("Error loading weather feed:", err);
    }
}
